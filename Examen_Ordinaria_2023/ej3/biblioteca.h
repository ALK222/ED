...
private:  
    Diccionario<tSignatura, tNumEjemplares> _libros; //Libros y ejemplares disponibles
    Diccionario<tCodigo, tNombre> _socios;    //Lista de clientes por codigo y nombre
    Diccionario<tCodigo, Diccionario<tSignatura, tFecha>> _prestados; //Lista de prestamos de un lector
    Diccionario<tSignatura, Lista<tCodigo>> _esperando; //Lista de espera por libro
