...
int main()
{
    ...
    while (cin >> comando)
    {
        if (comando == "an_atraccion")
            an_atraccion(parque);
        else if (comando == "an_ninio")
            an_ninio(parque);
        else if (comando == "poner_en_fila")
            poner_en_fila(parque);
        else if (comando == "avanzar")
            avanzar(parque);
        else if (comando == "atracciones_visitadas")
            atracciones_visitadas(parque);
        else if (comando == "numero_visitas")
            numero_visitas(parque);
    }
    return 0;
}
